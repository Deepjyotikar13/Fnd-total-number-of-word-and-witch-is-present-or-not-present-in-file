...
import os
total_file=os.listdir('/storage/emulated/0')#give your directory name
text_files_list=[]
for i in range(0,len(total_file)):
	 values=total_file[i]
	 if values[:-4:-1]=="txt":
	 	text_files_list.append(values)
print(text_files_list)#will return every txt file in your directery
